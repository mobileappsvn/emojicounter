...
public class MainActivity extends AppCompatActivity {
    ...
    static final String EMOJI = WOMAN_TECHNOLOGIST + " " + WOMAN_SINGER + " " + "\u2197\ufe0f";

    private TextView emojiCounterTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emojiCounterTextView = findViewById(R.id.emoji_counter_text_view);
        emojiCounterTextView.setText("");
        ...
        //emojiEditText.setText("\u2049\uFE0F\u0061\u0062\u0063\uD83C\uDFF4\uDB40\uDC67\uDB40\uDC62\uDB40\uDC77\uDB40\uDC6C\uDB40\uDC73\uDB40\uDC7F");
        emojiEditText.addTextChangedListener(textWatcherListener);
    ...
    private TextWatcher textWatcherListener = new TextWatcher() {
        ...
        public void afterTextChanged(Editable editable) {
            if (editable.toString().isEmpty()) {
                Log.e(TAG, "=> emojiNumber=0");
                emojiCounterTextView.setText("0");
            } else {
                int charNumberNeedTake = 31;
                //EmojiUtil.unitTest(editable.toString());
                String temp = EmojiUtil.subString(editable.toString(), charNumberNeedTake);
                Log.e(TAG, "=> subString(s.toString(), " + charNumberNeedTake + ")=" + temp + "|temp.countWithEmojiAndFullsize=" + EmojiUtil.countTextWithEmoji(temp) + "|length=" + temp.length());

                int emojiNumber = EmojiUtil.countTextWithEmoji(editable.toString());
                int emojiCounterCompat = EmojiUtil.getEmojiCount(editable.toString());
                emojiCounterTextView.setText(emojiNumber + " & " + emojiCounterCompat);

                Log.e(TAG, "=> emojiNumber=" + emojiNumber + "|getEmojiCount(EmojiCompat)=" + emojiCounterCompat);
